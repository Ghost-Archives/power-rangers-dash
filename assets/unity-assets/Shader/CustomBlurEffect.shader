...
Properties {
 ...
 _DownTex ("Downsampled (RGB)", 2D) = "black" {}
}
SubShader { 
 Pass {
  ZTest False
...
void main ()
{
  ...
  lowp vec4 tmpvar_4;
  tmpvar_4 = texture (_MainTex, xlv_TEXCOORD2);
  lowp vec4 tmpvar_5;
  tmpvar_5 = texture (_MainTex, xlv_TEXCOORD3);
  mediump vec4 tmpvar_6;
  tmpvar_6 = (((color_1 + tmpvar_3) + tmpvar_4) + tmpvar_5);
  color_1 = tmpvar_6;
...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((texture2D (_MainTex, xlv_TEXCOORD) * (1.0 - _Parameter.w)) + (texture2D (_DownTex, xlv_TEXCOORD) * _Parameter.w));
...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((texture (_MainTex, xlv_TEXCOORD) * (1.0 - _Parameter.w)) + (texture (_DownTex, xlv_TEXCOORD) * _Parameter.w));
